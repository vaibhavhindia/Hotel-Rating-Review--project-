...
pickle_in = open("D:\\Data Science\\All Projects\\ExcelR Projects Final file\\Hotel_Review_Classifier NLP (DS_P_139)\\lgbm_sentiment.pkl", 'rb')
...
if st.button("Analyze"):
    ...
    prdictionDist = model_sentiment.lgb.predict(..., pred_leaf = True)(tfIdfText)
